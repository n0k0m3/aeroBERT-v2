...
# CUDA_VISIBLE_DEVICES=0 ./pretrain_base.sh albert-base-v2 data/pretrain/train.txt data/pretrain/test.txt 32 > stdlog/log_base_albert-base-v2.txt 2>&1 &
# P1=$!
# CUDA_VISIBLE_DEVICES=1 ./pretrain_base.sh albert-large-v2 data/pretrain/train.txt data/pretrain/test.txt 16 > stdlog/log_base_albert-large-v2.txt 2>&1 &
# P2=$!
# CUDA_VISIBLE_DEVICES=2 ./pretrain_base.sh albert-xlarge-v2 data/pretrain/train.txt data/pretrain/test.txt 8 > stdlog/log_base_albert-xlarge-v2.txt 2>&1 &
# P3=$!
# CUDA_VISIBLE_DEVICES=3 ./pretrain_base.sh albert-xxlarge-v2 data/pretrain/train.txt data/pretrain/test.txt 4 > stdlog/log_base_albert-xxlarge-v2.txt 2>&1 &
# P4=$!
# wait $P1 $P2 $P3 $P4

# CUDA_VISIBLE_DEVICES=0 ./pretrain_base.sh roberta-base data/pretrain/train.txt data/pretrain/test.txt 32 > stdlog/log_base_roberta-base.txt 2>&1 &
# P1=$!
# CUDA_VISIBLE_DEVICES=1 ./pretrain_base.sh roberta-large data/pretrain/train.txt data/pretrain/test.txt 16 > stdlog/log_base_roberta-large.txt 2>&1 &
# P2=$!
# CUDA_VISIBLE_DEVICES=2 ./pretrain_base.sh microsoft/deberta-v3-base data/pretrain/train.txt data/pretrain/test.txt 16 > stdlog/log_base_deberta-v3-base.txt 2>&1 &
# P3=$!
# CUDA_VISIBLE_DEVICES=3 ./pretrain_base.sh microsoft/deberta-v3-large data/pretrain/train.txt data/pretrain/test.txt 8 > stdlog/log_base_deberta-v3-large.txt 2>&1 &
# P4=$!
# wait $P1 $P2 $P3 $P4
##################################
...
# CUDA_VISIBLE_DEVICES=0 ./classifier_base.sh albert-base-v2 data/classifier/train.json data/classifier/test.json 32 > stdlog/log_classifier_base_albert-base-v2.txt 2>&1 &
# P1=$!
# CUDA_VISIBLE_DEVICES=1 ./classifier_base.sh albert-large-v2 data/classifier/train.json data/classifier/test.json 16 > stdlog/log_classifier_base_albert-large-v2.txt 2>&1 &
# P2=$!
# CUDA_VISIBLE_DEVICES=2 ./classifier_base.sh albert-xlarge-v2 data/classifier/train.json data/classifier/test.json 8 > stdlog/log_classifier_base_albert-xlarge-v2.txt 2>&1 &
# P3=$!
# CUDA_VISIBLE_DEVICES=3 ./classifier_base.sh albert-xxlarge-v2 data/classifier/train.json data/classifier/test.json 4 > stdlog/log_classifier_base_albert-xxlarge-v2.txt 2>&1 &
# P4=$!
# wait $P1 $P2 $P3 $P4

CUDA_VISIBLE_DEVICES=0 ./classifier_base.sh roberta-base data/classifier/train.json data/classifier/test.json 32 > stdlog/log_classifier_base_roberta-base.txt 2>&1 &
P1=$!
CUDA_VISIBLE_DEVICES=1 ./classifier_base.sh roberta-large data/classifier/train.json data/classifier/test.json 16 > stdlog/log_classifier_base_roberta-large.txt 2>&1 &
P2=$!
CUDA_VISIBLE_DEVICES=2 ./classifier_base.sh microsoft/deberta-v3-base data/classifier/train.json data/classifier/test.json 16 > stdlog/log_classifier_base_deberta-v3-base.txt 2>&1 &
P3=$!
CUDA_VISIBLE_DEVICES=3 ./classifier_base.sh microsoft/deberta-v3-large data/classifier/train.json data/classifier/test.json 8 > stdlog/log_classifier_base_deberta-v3-large.txt 2>&1 &
P4=$!
wait $P1 $P2 $P3 $P4
##################################
...
# CUDA_VISIBLE_DEVICES=0 ./ner_base.sh albert-base-v2 data/ner/train.json data/ner/test.json 32 > stdlog/log_ner_base_albert-base-v2.txt 2>&1 &
# P1=$!
# CUDA_VISIBLE_DEVICES=1 ./ner_base.sh albert-large-v2 data/ner/train.json data/ner/test.json 16 > stdlog/log_ner_base_albert-large-v2.txt 2>&1 &
# P2=$!
# CUDA_VISIBLE_DEVICES=2 ./ner_base.sh albert-xlarge-v2 data/ner/train.json data/ner/test.json 8 > stdlog/log_ner_base_albert-xlarge-v2.txt 2>&1 &
# P3=$!
# CUDA_VISIBLE_DEVICES=3 ./ner_base.sh albert-xxlarge-v2 data/ner/train.json data/ner/test.json 4 > stdlog/log_ner_base_albert-xxlarge-v2.txt 2>&1 &
# P4=$!
# wait $P1 $P2 $P3 $P4

# CUDA_VISIBLE_DEVICES=0 ./ner_base.sh roberta-base data/ner/train.json data/ner/test.json 32 > stdlog/log_ner_base_roberta-base.txt 2>&1 &
# P1=$!
# CUDA_VISIBLE_DEVICES=1 ./ner_base.sh roberta-large data/ner/train.json data/ner/test.json 16 > stdlog/log_ner_base_roberta-large.txt 2>&1 &
# P2=$!
# CUDA_VISIBLE_DEVICES=2 ./ner_base.sh microsoft/deberta-v3-base data/ner/train.json data/ner/test.json 16 > stdlog/log_ner_base_deberta-v3-base.txt 2>&1 &
# P3=$!
# CUDA_VISIBLE_DEVICES=3 ./ner_base.sh microsoft/deberta-v3-large data/ner/train.json data/ner/test.json 8 > stdlog/log_ner_base_deberta-v3-large.txt 2>&1 &
# P4=$!
# wait $P1 $P2 $P3 $P4
